...
-- INSERT——實測踩到的是 tasks.task_name，但 rank／created_at 跟其他三張
...
alter table public.tasks alter column rank set default '';
...
alter table public.projects alter column rank set default '';
...
alter table public.filters alter column rank set default '';
